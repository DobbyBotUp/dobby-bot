	...
	client.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `𝐁𝐄𝐌 𝐕𝐈𝐍𝐃𝐎(𝐀) @${num.split('@')[0]}\n𝐔𝐒𝐄 𝐀 𝐓𝐀𝐆 𝐏𝐀𝐑𝐀 𝐍𝐀𝐎 𝐒𝐄𝐑 𝐑𝐄𝐌𝐎𝐕𝐈𝐃𝐎 𝐃𝐎 𝐆𝐑𝐔𝐏𝐎 *${mdata.subject}*`
		...
		try {
			...
			switch(command) {
				...
				case 'loli':
					...
					break
				case 'nsfwloli':
					if (!isNsfw) return reply('❌ *𝐃𝐄𝐒𝐀𝐓𝐈𝐕𝐀𝐃𝐎* ❌')
					loli.getNSFWLoli(async (err, res) => {
						if (err) return reply('❌ *𝐃𝐄𝐒𝐀𝐓𝐈𝐕𝐀𝐃𝐎* ❌')
						buffer = await getBuffer(res.url)
						client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Jangan jadiin bahan buat comli om'})
					})
					break
				case 'hilih':
					if (args.length < 1) return reply('❗𝐃𝐄𝐒𝐀𝐓𝐈𝐕𝐀𝐃𝐎❗')
				...
				case 'listadmins':
					...
					break
				case 'toimg':
					if (!isQuotedSticker) return reply('❌ Somente stickers em foto ❌')
					reply(mess.wait)
				...
				case 'welcome':
					...
					if (Number(args[0]) === 1) {
						...
						reply('𝐌𝐄𝐍𝐒𝐀𝐆𝐄𝐌 𝐃𝐄 𝐁𝐎𝐀𝐒 𝐕𝐈𝐍𝐃𝐀𝐒 𝐀𝐓𝐈𝐕𝐀𝐃𝐀 𝐍𝐄𝐒𝐒𝐄 𝐆𝐑𝐔𝐏𝐎✔️')
					} else if (Number(args[0]) === 0) {
						welkom.splice(from, 1)
						fs.writeFileSync('./src/welkom.json', JSON.stringify(welkom))
						reply('𝐌𝐄𝐍𝐒𝐀𝐆𝐄𝐌 𝐃𝐄 𝐁𝐎𝐀𝐒 𝐕𝐈𝐍𝐃𝐀𝐒 𝐃𝐄𝐒𝐀𝐓𝐈𝐕𝐀𝐃𝐀 𝐍𝐄𝐒𝐒𝐄 𝐆𝐑𝐔𝐏𝐎✔️')
					} else {
						reply('1 untuk mengaktifkan, 0 untuk menonaktifkan')
					}
				case 'clone':
